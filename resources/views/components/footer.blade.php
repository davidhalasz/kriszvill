<div class="w-full bg-[#232323] py-20 flex" id="kapcsolat">
    <div class="container mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-0 px-8 lg:px-0">
        ...
        <div class="flex justify-start md:justify-center">
            <div class="w-fit md:mx-auto flex flex-col">
                <h2 class="ralewayBold text-[#4DA7F7] text-xl md:text-2xl  mb-4 md:mb-8">Elérhetőségek</h2>
                <div class="flex text-gray-100 md:text-lg items-center">
                    ...
                    <p class="font-sans font-bold pl-4">+36 70 221 0396</p>
                </div>
        ...
        <div class="flex text-gray-100 text-lg">
            <div class="w-fit md:mx-auto flex flex-col">
                <h2 class="ralewayBold text-[#4DA7F7] text-xl md:text-2xl mb-4 md:mb-8">Menü</h2>
